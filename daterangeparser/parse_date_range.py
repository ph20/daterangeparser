...
MONTHS = {
    ...
    'січ': 1, 'січень': 1, 'січеня': 1,
    'лют': 2, 'лютий': 2, 'лютого': 2,
    'бер': 3, 'берез': 3, 'березень': 3, 'березеня': 3,
    'кві': 4, 'квіт': 4, 'квітень': 4, 'квітня': 4,
    'тра': 5, 'трав': 5, 'травня': 5, 'травень': 5,
    'чер': 6, 'черв': 6, 'червень': 6, 'червня': 6,
    'лип': 7, 'липень': 7, 'липня': 7,
    'сер': 8, 'серп': 8, 'серпня': 8, 'серпень': 8,
    'вер': 9, 'верес': 9, 'вересня': 9, 'вересень': 9,
    'жов': 10, 'жовт': 10, 'жовтня': 10, 'жовтень': 10,
    'лис': 11, 'лист': 11, 'листопад': 11, 'листопада': 11,
    'гру': 12, 'груд': 12, 'грудня': 12, 'грудень': 12,
}
